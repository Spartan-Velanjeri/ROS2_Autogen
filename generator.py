...
def generator(package_name, urdf_relative_path,sim_name,jsp_gui):
    ...
    jsp_gui = 1 if jsp_gui =="YES" else 0
    if jsp_gui:
    ...
    print(f"Your Package is complete and called {package_name}. Make sure to copy it in a colcon workspace and build")
...
if __name__ == "__main__":
    ...
    package_name = input(questions['package_name'])
    print("\n")
    urdf_relative_path = input(questions['urdf_relative_path'])
    print("\n")
    sim_name = input(questions['simulator_used'],)
    print("\n")
    meshes_required = input(questions['meshes'])
    jsp_gui = input(questions['jsp-gui'])
    generator(package_name, urdf_relative_path,sim_name,jsp_gui)